    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	<label for="lastname" class="col-sm-3 control-label">Nama Belakan</label>
                ...
                <div class="form-group">
                  	<label for="datepicker_add" class="col-sm-3 control-label">Tgl Lahir</label>
                ...
                <div class="form-group">
                    <label for="position" class="col-sm-3 control-label">Jabata</label>
          	...
          	<div class="modal-footer">
            	<button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Batal</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_position" class="col-sm-3 control-label">Jabatan</label>
